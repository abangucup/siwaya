...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var encryptedKey = "MDAwMC0wMDAwLTAwMC0wMDAw";
    var lightGalleryCoreSettings = {
        mode: 'lg-slide',
        easing: 'ease',
        speed: 400,
        licenseKey: atob(encryptedKey),
        height: '100%',
        width: '100%',
        addClass: '',
    ...
    var lgQuery = /** @class */ (function () {
        ...
        lgQuery.prototype.load = function (url) {
            fetch(url)
                .then((res) => res.text())
                .then((html) => {
                    this.selector.innerHTML = DOMPurify.sanitize(html); // Sanitasi data sebelum menampilkan
                })
                .catch((error) => {
                    console.error('Error loading content:', error); // Tangani kesalahan jika ada
                });
            return this;
        };
