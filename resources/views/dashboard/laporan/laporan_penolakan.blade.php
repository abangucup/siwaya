...
@section('title', 'Penolakan WBTB')

@section('pageTitle', 'Penolakan WBTB')

@section('pageContent')
<span class="fw-semibold fs-14 heading-font text-dark dot ms-2">List Penolakan WBTB</span>
@endsection

@section('content')

<div class="d-flex justify-content-end mb-4">
    <a href="{{ route('laporan.cetak.ditolak') }}" class="btn btn-danger text-white me-2" target="_blank">
        <i data-feather="file-text" class="me-2"></i> Cetak PDF
    </a>
    <a href="{{ route('laporan.export.ditolak') }}" class="btn btn-success text-white me-2" target="_blank">
