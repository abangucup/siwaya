...
@section('title', 'Verifikasi WBTB')

@section('pageTitle', 'Verifikasi WBTB')

@section('pageContent')
<span class="fw-semibold fs-14 heading-font text-dark dot ms-2">List Verifikasi WBTB</span>
@endsection

@section('content')

<div class="d-flex justify-content-end mb-4">
    <a href="{{ route('laporan.cetak.diverifikasi') }}" class="btn btn-danger text-white me-2" target="_blank">
        <i data-feather="file-text" class="me-2"></i> Cetak PDF
    </a>
    <a href="{{ route('laporan.export.diverifikasi') }}" class="btn btn-success text-white me-2" target="_blank">
