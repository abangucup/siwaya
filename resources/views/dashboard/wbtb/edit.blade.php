    ...
    <div class="col-lg-12">
        <div class="card bg-white border-0 rounded-10 mb-4">
            <div class="card-body p-4">
                <form action="{{ route('wbtb.update', $wbtb->slug) }}" method="POST" enctype="multipart/form-data" id="formWbtb">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <input type="text" class="form-control text-dark ps-5 h-58" name="nama_wbtb"
                                        required placeholder="Masukan Nama WBTB" value="{{ $wbtb->nama_wbtb }}">
                                    <i
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <textarea class="form-control ps-5 text-dark"
                                        ...
                                        name="deskripsi_wbtb">{{ $wbtb->deskripsi_wbtb }}</textarea>
                                    <i
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="form-group position-relative">
                                    <textarea class="form-control ps-5 text-dark" name="description_image"
                                        ...
                                        rows="5">{{ $wbtb->galeries->pluck('description_image')->implode(', ') }}</textarea>
                                    <i
                                        class="ri-information-line position-absolute top-0 start-0 fs-20 text-gray-light ps-20 pt-2"></i>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <a href="{{ route('wbtb.index') }}" class="btn btn-danger  py-3 px-5 w-100 mb-2 btn-sm">Batal</a>
                            <button type="submit" id="btnSubmit"
                                class="btn btn-warning py-3 px-5 text-white w-100">
