<header class="header-area bg-white mb-4 shadow-sm rounded-bottom-10" id="header-area">
        ...
        <div class="col-lg-4 col-sm-6 col-md-4">
            <div class="left-header-content">
                <ul
                    ...
                    <li>
                        <form class="src-form position-relative" action="{{ route('search') }}" method="POST">
                            @csrf
                            <input type="text" class="form-control" placeholder="Cari Sesuatu.." name="search">
                            <button type="submit"
                    ...
                    <li class="header-right-item">
                        <div class="dropdown admin-profile">
                            ...
                            <ul class="dropdown-menu border-0 bg-white w-100 admin-link">
                                <li>
                                    <a class="dropdown-item d-flex align-items-center text-body" href="{{ route('profile.index') }}">
