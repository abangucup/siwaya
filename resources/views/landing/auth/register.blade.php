<div class="modal fade modal-createAccount" id="createAccount" tabindex="-2" aria-labelledby="createAccountLabel"
        aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="flexCheckDefault2">
                                            <span>I agree to All
                                            </span><a "https://realstatic.staticmania.com/href">Terms & Conditions</a>
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="modal-footer text-center justify-content-center">
                    <p class="bold">Have an account? <a href="index.html#login" data-bs-toggle="modal"
                            data-bs-dismiss="modal">Log In </a> </p>
                </div>
            </div>
        </div>
    </div>