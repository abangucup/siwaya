...
class LaporanVerifikasiExport implements FromCollection, WithHeadings, WithDrawings
{
    ...
    {
        $drawings = [];
        $wbtbs = Wbtb::with('galeries')->where('status', 'diverifikasi')->get(); // Pastikan sama dengan data di `collection()`
