...
class LaporanPengajuanExport implements FromCollection, WithHeadings, WithDrawings
{
    ...
    {
        $drawings = [];
        $wbtbs = Wbtb::with('galeries')->where('status', 'diajukan')->get(); // Pastikan sama dengan data di `collection()`
