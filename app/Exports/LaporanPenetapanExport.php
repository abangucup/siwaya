...
class LaporanPenetapanExport implements FromCollection, WithHeadings, WithDrawings
{
    ...
    {
        $drawings = [];
        $wbtbs = Wbtb::with('galeries')->where('status', 'ditetapkan')->get(); // Pastikan sama dengan data di `collection()`
